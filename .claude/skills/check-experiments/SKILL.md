...
description: Check running experiments and collect results. TRIGGER when the user says "check experiments", "check results", "any experiments done", "check iterations", "what's running", or wants to see the status of launched experiments.
argument-hint:
disable-model-invocation: false
allowed-tools: Bash(python:*), Bash(cat:*), Bash(test:*), Bash(bash:*), Bash(git diff:*), Bash(git add:*), Bash(git commit:*), Bash(git branch:*), Read, Grep
---
